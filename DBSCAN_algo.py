...
df.loc[df['z'] < 3.5, 'classification'] = 'Ground'
df.loc[(df['z'] > 3.5) & (df['z'] < 12.5), 'classification'] = 'Vegetation'
df.loc[df['z'] > 11.5, 'classification'] = 'Building'
